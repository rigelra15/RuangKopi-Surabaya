...
export default function SearchBox({
  ...
  const [geocodedLocation, setGeocodedLocation] =
    useState<GeocodedResult | null>(null);
        ...
        if (isAddressQuery(searchQuery) && searchQuery.length >= 5) {
          ...
          try {
            ...
            if (location && location.displayName) {
              ...
              const nearbyCafes = await searchCafesNearLocation(
                location.lat,
                location.lon,
                1
              );
              ...
              {addressCafes.length > 0 && (
                <>
                  ...
                  >
                    ...
                    >
                      {language === "id"
                        ? "Cafe terdekat dari lokasi:"
                        : "Nearest cafes from location:"}
                    </span>
                  </div>
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  {language === "id" ? "cafe ditemukan" : "cafes found"}
                </span>
              </div>
              ...
              {searchResults.slice(0, 10).map((cafe) => (
                ...
                >
                  ...
                  {cafe.logo ? (
                    <div className="flex-shrink-0 w-8 h-8 sm:w-9 sm:h-9 rounded-lg overflow-hidden mt-0.5">
                      <img
                        src={cafe.logo}
                        alt={cafe.name}
              ...
              {searchResults.length > 10 && (
                ...
                >
                  <span className="text-xs sm:text-sm">
                    +{searchResults.length - 10}{" "}
                    {language === "id" ? "cafe lainnya" : "more cafes"}
                  </span>
                </div>
              )}
            </>
