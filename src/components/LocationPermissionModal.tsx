...
export default function LocationPermissionModal({
  ...
  const t = {
    id: {
      ...
      description:
        "Izinkan RuangKopi mengakses lokasi Anda untuk menampilkan cafe terdekat dan menghitung jarak.",
      benefits: [
        "Temukan cafe terdekat dari posisi Anda",
        "Lihat jarak ke setiap cafe",
      ],
      privacy:
        "Lokasi Anda hanya digunakan secara lokal dan tidak akan disimpan.",
    ...
    en: {
      ...
      description:
        "Allow RuangKopi to access your location to show nearby cafes and calculate distances.",
      benefits: [
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[3000] flex items-end md:items-center justify-center md:p-4">
          {/* Backdrop */}
          <motion.div
          ...
          <motion.div
            ...
            exit="exit"
            className={`
              relative w-full md:max-w-sm rounded-t-3xl md:rounded-2xl overflow-hidden
              ${
                isDarkMode
